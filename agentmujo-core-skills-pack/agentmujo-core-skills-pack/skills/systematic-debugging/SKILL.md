...
description: Perform evidence-driven diagnosis and root-cause analysis.
---

# systematic-debugging

Reproduce or characterize the problem, gather evidence, form falsifiable hypotheses, test them, identify root cause, apply the smallest justified fix, and verify.
