...
description: Check WordPress security, plugins, themes and configuration.
license: MIT
...
## Purpose
Check WordPress security, plugins, themes and configuration.

Perform defensive security checks on updates, plugins, themes, accounts, permissions and configuration.
