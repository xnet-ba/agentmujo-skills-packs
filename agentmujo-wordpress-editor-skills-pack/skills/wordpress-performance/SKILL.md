...
description: Analyze and improve WordPress performance and Core Web Vitals.
license: MIT
...
## Purpose
Analyze and improve WordPress performance and Core Web Vitals.

Identify common page-speed bottlenecks in themes, plugins, queries, assets, caching and hosting.
