...
description: Evaluate technologies, alternatives, trade-offs and technical decisions.
license: MIT
compatibility: OpenCode native Agent Skills; adapt actions to the target project, platform and available tools.
metadata:
  pack: agentmujo-engineer-skills-pack
  version: "1.0.0"
---
...
Compare options using requirements, cost, risk, maintainability, performance and reversibility.
