...
description: Design logging, metrics, tracing, monitoring and observability.
license: MIT
...
## Purpose
Design logging, metrics, tracing, monitoring and observability.

Create actionable telemetry that supports diagnosis, alerting, SLOs and operational learning.
