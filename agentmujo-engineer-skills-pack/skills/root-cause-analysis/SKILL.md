...
description: Perform structured investigation and identify underlying causes.
license: MIT
...
Separate symptoms from causes using timelines, evidence, hypotheses and validation.
