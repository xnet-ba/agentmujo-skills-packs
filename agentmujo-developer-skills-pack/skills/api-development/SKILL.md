...
description: Design, implement, test and document APIs.
license: MIT
...
## Purpose
Design, implement, test and document APIs.

Create and evolve APIs with clear contracts, validation, errors, versioning and compatibility considerations.
