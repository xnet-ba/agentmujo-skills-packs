...
description: Develop backend services, business logic and server-side applications.
license: MIT
...
## Purpose
Develop backend services, business logic and server-side applications.

Implement backend behavior, services, validation, errors, persistence and integrations using project conventions.
