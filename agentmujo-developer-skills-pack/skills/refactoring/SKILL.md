---
name: refactoring
description: Safely improve code structure, readability and maintainability.
license: MIT
...
## Purpose
Safely improve code structure, readability and maintainability.

Refactor without changing intended behavior; use tests and small diffs to control risk.
