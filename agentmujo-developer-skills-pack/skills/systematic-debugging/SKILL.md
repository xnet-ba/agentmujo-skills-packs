...
description: Diagnose software problems using structured root-cause analysis.
license: MIT
...
## Purpose
Diagnose software problems using structured root-cause analysis.

Investigate failures from evidence and reproduce symptoms before making targeted fixes.
