...
description: Create and maintain technical documentation and developer guides.
license: MIT
...
Write accurate docs for setup, architecture, APIs, operations, development and troubleshooting.
