...
description: Identify and address application security vulnerabilities.
license: MIT
...
## Purpose
Identify and address application security vulnerabilities.

Review auth, authorization, input handling, secrets, dependencies, data exposure and common application attack paths.
