...
description: Develop frontend applications, UI components and client-side logic.
license: MIT
...
## Purpose
Develop frontend applications, UI components and client-side logic.

Implement accessible, maintainable frontend behavior while preserving existing design and application architecture.
