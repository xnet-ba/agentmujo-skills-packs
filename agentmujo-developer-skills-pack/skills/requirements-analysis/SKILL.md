...
description: Convert requirements into technical specifications and implementation tasks.
license: MIT
...
## Purpose
Convert requirements into technical specifications and implementation tasks.

Turn user goals into explicit acceptance criteria, constraints, edge cases, dependencies and implementation steps.
