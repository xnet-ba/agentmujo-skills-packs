...
description: Create unit, integration, end-to-end and automated tests.
license: MIT
...
## Purpose
Create unit, integration, end-to-end and automated tests.

Select appropriate tests, create reproducible fixtures, run targeted checks and prevent regressions.
