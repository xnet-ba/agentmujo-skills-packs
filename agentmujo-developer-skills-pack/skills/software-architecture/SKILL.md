...
description: Design software architecture, components, interfaces and dependencies.
license: MIT
...
## Purpose
Design software architecture, components, interfaces and dependencies.

Design maintainable architecture, boundaries, interfaces, data flow and trade-offs appropriate to the project.
