...
description: Analyze, clean, transform and summarize spreadsheet data.
license: MIT
...
## Purpose
Analyze, clean, transform and summarize spreadsheet data.

Inspect tabular data, validate assumptions, clean values, compute summaries and identify anomalies.
