...
description: Manage schedules, appointments, meetings and calendar workflows.
license: MIT
compatibility: OpenCode native Agent Skills; adapt actions to the target project, platform and available tools.
metadata:
  pack: agentmujo-office-worker-skills-pack
  version: "1.0.0"
---
...
## Purpose
Manage schedules, appointments, meetings and calendar workflows.

Find scheduling constraints, propose practical times and maintain accurate event details when calendar access is available.
