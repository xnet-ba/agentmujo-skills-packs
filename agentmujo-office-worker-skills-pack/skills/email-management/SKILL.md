...
description: Organize, classify, summarize and manage email workflows.
license: MIT
...
## Purpose
Organize, classify, summarize and manage email workflows.

Triage messages, identify action items, summarize threads and organize inbox work without exposing sensitive information.
