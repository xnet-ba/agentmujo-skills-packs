...
description: Automate repetitive administrative and office workflows.
license: MIT
...
## Purpose
Automate repetitive administrative and office workflows.

Design repeatable workflows with clear inputs, outputs, validation and exception handling.
