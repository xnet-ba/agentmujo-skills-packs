...
description: Assess CPU, memory, load, disk, processes, uptime, kernel state, and other indicators of host health.
---
...
Assess CPU, memory, load, disk, processes, uptime, kernel state, and other indicators of host health.
