...
description: Orchestrate Linux server administration tasks by combining the minimum relevant server skills.
---

# Linux Server Admin coordinator

## Purpose

Orchestrate Linux server administration tasks by combining the minimum relevant server skills.
