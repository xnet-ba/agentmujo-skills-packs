...
description: Diagnose interfaces, addresses, routes, DNS, sockets, ports, connectivity, and network service reachability.
---
...
Diagnose interfaces, addresses, routes, DNS, sockets, ports, connectivity, and network service reachability.
