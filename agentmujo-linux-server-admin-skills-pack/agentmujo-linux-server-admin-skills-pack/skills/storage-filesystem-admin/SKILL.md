...
description: Inspect disks, partitions, filesystems, mounts, permissions, capacity, and storage-related failures.
---
...
Inspect disks, partitions, filesystems, mounts, permissions, capacity, and storage-related failures.
